...
public class Student extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 5983595145598275533L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Student\",\"namespace\":\"example.avro\",\"fields\":[{\"name\":\"name\",\"type\":\"string\"},{\"name\":\"age\",\"type\":[\"int\",\"null\"]}]}");
   ...
   */
  public Student(java.lang.CharSequence name, java.lang.Integer age) {
    this.name = name;
    this.age = age;
  }
   ...
   */
  public static example.avro.Student.Builder newBuilder() {
    return new example.avro.Student.Builder();
  }
   ...
   * @return A new Student RecordBuilder
   */
  public static example.avro.Student.Builder newBuilder(example.avro.Student.Builder other) {
    if (other == null) {
      return new example.avro.Student.Builder();
    } else {
      return new example.avro.Student.Builder(other);
    }
  }
   ...
   * @return A new Student RecordBuilder
   */
  public static example.avro.Student.Builder newBuilder(example.avro.Student other) {
    if (other == null) {
      return new example.avro.Student.Builder();
    } else {
      return new example.avro.Student.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Student>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(example.avro.Student.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(example.avro.Student other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.name)) {
        this.name = data().deepCopy(fields()[0].schema(), other.name);
    ...
    /**
      ...
      * @return This builder.
      */
    public example.avro.Student.Builder setName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public example.avro.Student.Builder clearName() {
      name = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public example.avro.Student.Builder setAge(java.lang.Integer value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public example.avro.Student.Builder clearAge() {
      age = null;
